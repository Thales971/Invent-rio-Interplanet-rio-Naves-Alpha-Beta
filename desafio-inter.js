...
//Removendo a tarefa repetida
  console.log
("Antes do pop");
console.table(inventarioAlpha);

// Removendo ultimo estilo
let estiloRemovido = inventarioAlpha.pop();
...
let inventarioBeta = [
  ...
  // Removendo ultimo estilo
  let estiloRemovidoo = inventarioBeta.pop();
  ...
  console.log
("Antes do push");
console.table(inventarioAlphaa);

inventarioAlphaa.push (["Máquina de portais","Terra",9090]);
inventarioAlphaa.push (["Omnitrix","Terra",10000]);
inventarioAlphaa.push (["Nanites","Terra",2010]);
...
let inventarioBetaa = [
  ...
  console.log
("Antes do push");
console.table(inventarioBetaa);

inventarioBetaa.push (["Disruptor de plasma","kepler",3455]);
inventarioBetaa.push (["Zagrs","Kepler",1100]);
...
let inventarioAlphaaa = [
  ...
  let itemDestacado = inventarioAlphaaa[3];
  console.log(itemDestacado);
  
  
  inventarioAlphaaa.unshift(itemDestacado);
  inventarioAlphaaa.splice(3,1);
  
  console.log("Depois do Unshift");
  console.table(inventarioAlphaaa);

  console.log("------------------------");

  //6

  let inventarioBetaaa = [
    ["Lâmina Solar", "Mercúrio", 6700],
    ["Cometa Engarrafado", "Netuno", 7600],
    ["Relíquia de Zordon", "Elysium", 25000],
    ["Pó Lunar", "Lua", 2900],
  ...
  let itemDestacadoo = inventarioBetaaa[10];
  console.log(itemDestacadoo);
  
  
  inventarioBetaaa.unshift(itemDestacadoo);
  inventarioBetaaa.splice(10,1);
  
  console.log("Depois do Unshift");
  console.table(inventarioBetaaa);

  console.log("------------------------");

  //7
  let inventarioAlpha1 = [
    ["Cristal Rubion", "Plutão", 4500],
    ["Cápsula de Éter", "Júpiter", 7800],
    ["Nanofibra Luminosa", "Saturno", 12000],
    ["Minério Dourado", "Marte", 8500],
  ...
  console.log
("Antes do Shift");
console.table(inventarioAlpha1);

// Removendo o primeiro
let estiloRemovido1 = inventarioAlpha1.shift();

console.log("Depois do shift");
console.log(inventarioAlpha1);

console.log
("Objeto removido:", estiloRemovido1)
...
let inventarioBeta1 = [
  ...
  console.log
  ("Antes do Shift");
  console.table(inventarioBeta1);
  
  // Removendo o primeiro
  let estiloRemovido2 = inventarioBeta1.shift();
  
  console.log("Depois do shift");
  console.log(inventarioBeta1);
  
  console.log
  ("Objeto removido:", estiloRemovido2)
...
let inventarioBeta3 = [
  ...
  let itens10 = inventarioBeta3.slice(0,10);
  console.log(itens10.join(", "));
  ...
  console.log("parte da lista (índices 0 ao 5):", inventarioBeta2.slice(0, 5)); 
  ...
  let dezUltimos = inventarioAlpha3.slice(16,27);
  ...
  let itemSubstituido = inventarioAlpha4.splice(4,0);
  console.log(`Item a ser atualizado ${itemSubstituido}`);
  let itemAtualizado = inventarioAlpha4.splice(4,0, ["Ampulheta galatica 2.0", "Venus", 2200]);
  console.log("Lista atualizada");
  console.log(inventarioAlpha4);
  console.log("-------------------");
  ...
  let noMeio = inventarioBeta4.length/2
  console.log(noMeio);
  let itemInfectado = inventarioBeta4.splice(11,2)
  console.log(`Os itens infectados  [${itemInfectado.join(" /")}] foram contaminados`);

  console.log("Lista atualizada");
  console.table(itemInfectado);
  console.log(inventarioBeta4);

  console.log("----------------------");

  //17

  let inventarioAlphau = [
    ["Cristal Rubion", "Plutão", 4500],
    ["Cápsula de Éter", "Júpiter", 7800],
    ["Nanofibra Luminosa", "Saturno", 12000],
    ["Minério Dourado", "Marte", 8500],
  ...
  let listaUnida = inventarioAlphau.concat(inventarioBetau);
